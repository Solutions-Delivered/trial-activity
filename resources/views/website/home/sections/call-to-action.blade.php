    ...
    <div class="gap-8 items-center py-12 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        <div>
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                Try our mobile application on android and ios.
            </h2>
            <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
                Download our mobile application to get access to our services and products. We are available on both
                android and ios devices. Get your health and fitness on the go.
            </p>
        ...
        <img class="hidden mx-auto w-64 md:flex" src="{{ asset('images/mobile-app.png') }}" alt="Mobile app">
    </div>
</section>
