<footer class="relative bg-gray-50 dark:bg-gray-800">
    <div class="p-4 py-8 mx-auto max-w-screen-xl md:p-16 lg:-10">
        <div class="grid grid-cols-2 gap-8 lg:grid-cols-6">
            <div class="col-span-2">
                ...
                <p class="my-4 font-light text-gray-500 dark:text-gray-400">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Distinctio, dolorum totam reprehenderit
                    porro eaque libero sapiente laudantium.
                </p>
        ...
        <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2024-2025 <a href="#"
