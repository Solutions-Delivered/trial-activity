<header x-data="{ isOpen: false, isProductMenuOpen: false }" class="absolute inset-x-0 top-0 z-50">
    ...
    <div x-show="isOpen" @click.away="isOpen = false" class="lg:hidden fixed inset-0 z-50 bg-white">
            ...
            <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-gray-500/10">
                    <div class="space-y-2 py-6">
                        <div class="-mx-3">
                            <button @click="isProductMenuOpen = !isProductMenuOpen" type="button"
                            ...
                            <div x-show="isProductMenuOpen" class="mt-2 space-y-2" id="disclosure-1">
                                <a href="#"
